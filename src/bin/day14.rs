            ...
            Operation::SetMask(s) => {
                ...
                for (bitpos, ch) in s.chars().rev().enumerate() {
                    ...
                    match ch {
                        ...
                        '0' => (),
                        _ => {
                            panic!("v2: unexpected character '{}'", ch);
                        }
                    }
                }
            }
            ...
            Operation::SetMask(s) => {
                ...
                for (bitpos, ch) in s.chars().rev().enumerate() {
                    ...
                    match ch {
                        ...
                        '0' => (),
                        _ => {
                            panic!("v1: unexpected character '{}'", ch);
                        }
                    }
                }
            }
...
fn run() -> Result<(), String> {
    let operations =
        read_input(io::BufReader::new(io::stdin())).expect("unable to read operations list");
    println!(
        "Part 1: sum = {}",
